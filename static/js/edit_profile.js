...
/*
Set it up so that both do post so that you dont need to manipulate the url sometimes. Try to see if it is possible to pull data without 
having to  do more db queries


fucking grab the name too when sending for querey stock
*/